...
export default function CargoTrackingPage() {
  ...
  const [activeTracking, setActiveTracking] = useState<"air" | "sea">("air");
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="pt-16">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-center gap-4 mt-8">
          <button
            className={`px-6 py-2 mb-2 rounded-md font-semibold border transition ${
              activeTracking === "air"
                ? "bg-fastblue text-white border-fastblue"
                : "bg-white text-fastblue border-fastblue hover:bg-fastblue hover:text-white"
            }`}
            onClick={() => setActiveTracking("air")}
          >
            Air Cargo Tracking
          </button>
          <button
            className="px-6 py-2 mb-2 rounded-md font-semibold border border-fastblue bg-white text-fastblue hover:bg-fastblue hover:text-white transition"
            onClick={handleSeaCargoClick}
          >
            Sea Cargo Tracking
          </button>
        </div>
        {/* Only show Air Cargo tracking if selected */}
        {activeTracking === "air" && (
          <>
            {/* Hero Section */}
        ...
        {/* If you want to show a message or loader for Sea Cargo, you can add it here */}
      </div>
      <Footer />
    </div>
  );
